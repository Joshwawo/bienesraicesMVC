...
describe('Prueba la navegacion y Routing del Header y Footer', () =>{
    ...
    it('Prueba la navegacion del Header', ()=>{
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').should('not.length', 5);
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(3).invoke('text').should('equal', 'Contactanos');
    ...
    it('Prueba la navegacion del Footer', ()=>{
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').should('not.length', 5);
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(3).invoke('text').should('equal', 'Contactanos');
